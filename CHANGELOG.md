...
- 519 unit tests pass on CPU (was 451 in v0.4.0; +68 new across max_context_length, validity dataclasses, the ``min_valid_fraction`` floor, pipeline validity wiring, pdn formula, schema migration, viz). Full tree (CI scope, ``pytest tests/``): 1001 passed, 7 skipped.
